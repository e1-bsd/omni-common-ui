      ...
      function renderInputText() {
        if (suffix) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', style: _this.props.inputStyle,
        ...
        return _react2.default.createElement('input', { type: 'text', style: _this.props.inputStyle,
          className: inputClasses,
          name: _this.props.name,
          disabled: _this.props.disabled,
          required: _this.props.required,
...
TextInput.propTypes = {
  ...
  acceptedChars: _react2.default.PropTypes.object
};
