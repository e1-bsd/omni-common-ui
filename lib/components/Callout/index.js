...
Callout.propTypes = {
  ...
  points: _propTypes2.default.arrayOf(function (val, key) {
  ...
  offset: _propTypes2.default.arrayOf(function (val, key) {
    if (_is_js2.default.number(val) && val.length === 2 && key < 2) return true;
