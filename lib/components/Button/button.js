...
var Button = function (_PureComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function _handleButtonClick(e) {
      ...
      var ret = _is_js2.default.function(onClick) && onClick(e);
    ...
    value: function _renderButton(type, modeClasses) {
      ...
      var assignOnClick = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
Button.propTypes = {
  ...
  onClickActiveClassRemoveDelay: _propTypes2.default.number // default: 1000ms
};
