...
var NumberInput = function (_PureComponent) {
  ...
  _createClass(NumberInput, [{
    ...
    value: function _sendCallbackWithNewValue(newValue) {
      if (newValue !== this._value && _is_js2.default.function(this.props.onChange)) {
    ...
    key: '_getValidNumber',
    value: function _getValidNumber() {
      for (var _len = arguments.length, values = Array(_len), _key = 0; _key < _len; _key++) {
        values[_key] = arguments[_key];
      }

      var validNumber = values.find(function (value) {
        return _is_js2.default.number(value);
      });
      if (_is_js2.default.not.number(validNumber)) return '';
      return validNumber;
    }
  }, {
    key: 'render',
    value: function render() {
      var inputValue = this._getValidNumber(this._value, this._defaultValue);
