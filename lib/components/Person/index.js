...
var Person = function (_PureComponent) {
  _inherits(Person, _PureComponent);
  ...
  _createClass(Person, [{
    ...
    value: function _setUp(props) {
      ...
      this._picture = picture ? _react2.default.createElement(picture.type, _extends({}, picture.props, {
        className: (0, _classnames3.default)(picture.props.className, _style2.default.Person_picture, _defineProperty({}, _style2.default.Person_picture_vertical, props.vertical)) })) : null;
    }
  }, {
    key: '_showWarnings',
