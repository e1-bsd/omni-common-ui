...
var Profile = function Profile(props, _ref) {
  ...
  var placeholder = _react2.default.createElement('div', { className: _style2.default.StudentCard_profile_linePlaceholder });
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_2.default.Person, { className: props.className,
      ...
      gender: props.gender,
      nameNode: isPlaceholder ? placeholder : renderName('name', name, nameClass, props.nameLink),
      localNameNode: isPlaceholder ? placeholder : renderName('localName', props.localName, localNameClass),
