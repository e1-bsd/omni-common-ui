...
var Profile = function Profile(props, _ref) {
  ...
  var classes = (0, _classnames7.default)(_style2.default.StudentCard_profile, _style2.default.__1, (_classnames = {}, _defineProperty(_classnames, _style2.default.__separated, withSeparatorLine), _defineProperty(_classnames, _style2.default.__backgroundless, backgroundless), _defineProperty(_classnames, _style2.default.__vertical, vertical), _classnames), props.className);

  var renderName = function renderName(prop, name, nameClasses, onClick) {
    if (!name) {
      return;
    }
    var nameClass = (0, _classnames7.default)(nameClasses, _defineProperty({}, _style2.default.__active, _is_js2.default.existy(onClick)));
  ...
  var nameClass = (0, _classnames7.default)(_style2.default.StudentCard_profile_name, (0, _testClass2.default)('studentCard-name'), _defineProperty({}, _style2.default.__vertical, vertical));
  var localNameClass = (0, _classnames7.default)(_style2.default.StudentCard_profile_localName, (0, _testClass2.default)('studentCard-localName'), _defineProperty({}, _style2.default.__vertical, vertical));
  var statusClass = (0, _classnames7.default)(_style2.default.StudentCard_profile_status, (0, _testClass2.default)('studentCard-status'));
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_StudentPicture2.default, { src: props.avatarUrl,
        gender: props.gender,
        className: (0, _classnames7.default)(_style2.default.StudentCard_profile_image, (_classnames5 = {}, _defineProperty(_classnames5, _style2.default.__bigger, !!props.withBiggerAvatar), _defineProperty(_classnames5, _style2.default.__vertical, vertical), _classnames5)) }),
