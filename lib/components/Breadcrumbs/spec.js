...
describe('<Breadcrumbs />', function () {
  ...
  describe('check basic render functionality', function () {
    ...
    var items = [groupLink, markAttendanceLink];
    var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, { items: items }));
    ...
    it('back button has been rendered properly', function () {
      (0, _chai.expect)(wrapper.find('.' + _style2.default.Breadcrumbs_crumb_back)).to.have.length(1);
    });
