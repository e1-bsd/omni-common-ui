...
var Breadcrumbs = function (_Component) {
  ...
  _createClass(Breadcrumbs, [{
    ...
    value: function render() {
      ...
      if (!this.props.items || !this.props.items.some(function (item) {
        return !item.hidden;
      })) {
        return null;
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          itemsToRender.map(function (item, idx) {
            ...
            var itemClassNames = (0, _classnames4.default)(_style2.default.Breadcrumbs_crumb, (_classnames2 = {}, _defineProperty(_classnames2, indexedCrumbClassName, !!indexedCrumbClassName), _defineProperty(_classnames2, _style2.default.__clickable, !!item.clickable), _defineProperty(_classnames2, _style2.default.__hidden, !!item.hidden), _classnames2));
...
Breadcrumbs.propTypes = {
  ...
  items: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
    ...
    clickable: _react2.default.PropTypes.bool.isRequired,
    backLinkHref: _react2.default.PropTypes.string.isRequired })).isRequired,
  singleLineMode: _react2.default.PropTypes.bool,
