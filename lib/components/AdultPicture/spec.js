...
test('passes properties properly to Avatar', function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_.AdultPicture, { src: _testImage2.default, className: 'aClass' }));
