...
describe('Dialog', function () {
  ...
  context('close button', function () {
    it('contains a close button icon when enabled', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, { isOpen: true, withCloseButton: true }));
    ...
    it('does not contain a close button icon when not enabled', function () {
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, { isOpen: true }));
    ...
    it('calls `onRequestClose` when the close button is clicked', function () {
      ...
      var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, { isOpen: true, withCloseButton: true, onRequestClose: onRequestClose }));
