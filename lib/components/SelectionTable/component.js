...
var SelectionTable = function (_PureComponent) {
  _inherits(SelectionTable, _PureComponent);
  ...
  _createClass(SelectionTable, [{
    ...
    value: function _renderHeading() {
      ...
      var headerClassName = (0, _classnames2.default)(this.props.headerClassName, _style2.default.SelectionTable_header);
