          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              options.map(function (option) {
                var className = (0, _classnames3.default)(_style2.default.HorizontalSelect_option, _defineProperty({}, _style2.default.HorizontalSelect_option_active, option.value === _this2.state.value));
                if (!option._onClick) {
...
HorizontalSelect.propTypes = {
  options: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
    html: _react2.default.PropTypes.node,
    value: _react2.default.PropTypes.string
  })).isRequired,
  value: _react2.default.PropTypes.string,
  getLinkHrefForValue: _react2.default.PropTypes.func.isRequired,
