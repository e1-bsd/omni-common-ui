...
var _ExpandableAnimationItem = require('../ExpandableAnimationItem');

var _ExpandableAnimationItem2 = _interopRequireDefault(_ExpandableAnimationItem);
...
var HorizontalSelect = function (_PureComponent) {
  ...
  _createClass(HorizontalSelect, [{
    ...
    value: function _renderOptions() {
      ...
      var getLinkHrefForValue = this.props.getLinkHrefForValue;
      ...
      return _react2.default.createElement(
        ...
        this.props.options.map(function (option) {
          ...
          return _react2.default.createElement(
            'li',
            { key: option.value, className: optionClassName },
    ...
    key: '_renderHorizontalSelect',
    value: function _renderHorizontalSelect() {
      return _react2.default.createElement(
        _ExpandableAnimationItem2.default,
        { isExpand: !this.props.isHide, height: 150 },
        _react2.default.createElement(
...
HorizontalSelect.propTypes = {
  ...
  isHide: _propTypes2.default.bool
};
