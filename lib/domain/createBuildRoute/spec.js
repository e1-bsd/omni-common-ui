...
describe('normalizeUrl()', function () {
  test('supports file:// protocol', function () {
    expect((0, _.normalizeUrl)('file:///test/path')).toMatch('file:///test/path');
  });

  test('removes duplicated slashes', function () {
    expect((0, _.normalizeUrl)('/test//path')).toMatch('/test/path');
    expect((0, _.normalizeUrl)('/test///path')).toMatch('/test/path');
    expect((0, _.normalizeUrl)('/test_///path')).toMatch('/test_/path');
    expect((0, _.normalizeUrl)('/test9///path')).toMatch('/test9/path');
    expect((0, _.normalizeUrl)('/test-///path')).toMatch('/test-/path');
  });

  test('resolves two dots going up one level', function () {
    expect((0, _.normalizeUrl)('/test/../path')).toMatch('/path');
    expect((0, _.normalizeUrl)('/test/path/..')).toMatch('/test');
    expect((0, _.normalizeUrl)('/test/path9/..')).toMatch('/test');
    expect((0, _.normalizeUrl)('/test/path_/..')).toMatch('/test');
    expect((0, _.normalizeUrl)('/test/path-/..')).toMatch('/test');
    expect((0, _.normalizeUrl)('/test/sublevel/../path')).toMatch('/test/path');
    expect((0, _.normalizeUrl)('/../test/path')).toMatch('/test/path');
  });
