...
test('creates some actions!', function () {
...
test('calls basic fetch once when a `payload` was not supplied', function () {
  var thunk = (0, _2.default)('object', 'url', 'method');
  var fetch = jest.spyOn(_Api2.default, 'fetch').mockImplementation(function (url) {
    return url;
  });
  fetch.mockClear();
  thunk(function () {
...
test('calls supplied fetch once when a `payload` was supplied', function () {
  var fetch = jest.spyOn(_Api2.default, 'fetch').mockImplementation(function (url) {
    return url;
  });
  fetch.mockClear();
