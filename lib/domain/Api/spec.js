...
describe('#fetch', function () {
  describe('includeBearerTokenInApiGetUrls=undefined', function () {
    ...
    describe('when the response has a failing status', function () {
      test('converts to camel case its properties if an object is received in the response', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
        var _require4, fetch;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                expect.assertions(1);
                _isomorphicFetch2.default.mockResponse(JSON.stringify({ 'A-foo': 'bar' }), { status: 500 });
                _require4 = require('./'), fetch = _require4.fetch;
                _context2.prev = 3;
                _context2.next = 6;
                return fetch('https://domain/somePath');
              ...
              case 8:
                ...
                expect(_context2.t0.response.aFoo).toBe('bar');
      ...
      test('does not touch the response if it is not an object', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
        var _require5, fetch;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                expect.assertions(1);
                _isomorphicFetch2.default.mockResponse('some error', { status: 500 });
                _require5 = require('./'), fetch = _require5.fetch;
                _context3.prev = 3;
                _context3.next = 6;
                return fetch('https://domain/somePath');
              ...
              case 8:
                ...
                expect(_context3.t0.response).toBe('some error');
