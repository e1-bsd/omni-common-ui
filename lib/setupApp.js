...
require('./assets/styles/base/base.postcss');
...
var _PermissionHandler = require('./containers/PermissionHandler');

var _PermissionHandler2 = _interopRequireDefault(_PermissionHandler);
...
function setupApp(_ref) {
  ...
  var parsedRoutes = (0, _parseRoutes2.default)([{
    ...
    component: _SingleSignOn.SingleSignOnHandler,
    childRoutes: [{
      ...
      childRoutes: [{
        ...
        childRoutes: [{
          ...
          childRoutes: [{
            component: _PermissionHandler2.default,
            childRoutes: [{
