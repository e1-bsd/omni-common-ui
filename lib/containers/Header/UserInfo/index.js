    ...
    value: function _onLogoutButtonClicked() {
      ...
      _alertifyjs2.default.confirm().setting({
        ...
        onok: function onok() {
          ...
          _this2.props.triggerSignOutRedirect();
        }
      }).show();
    }
  }, {
...
UserInfo.propTypes = {
  ...
  triggerSignInRedirect: _propTypes2.default.func.isRequired,
  triggerSignOutRedirect: _propTypes2.default.func.isRequired
};
...
function mapDispatchToProps(dispatch) {
  return Object.assign({}, (0, _redux.bindActionCreators)(_Privileges.actions, dispatch), (0, _redux.bindActionCreators)(_Impersonate.actions, dispatch), (0, _redux.bindActionCreators)(_SingleSignOn.actions, dispatch));
}
