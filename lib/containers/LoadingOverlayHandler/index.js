...
// config feature flag
var IS_ACTIVE = !!_Config2.default.get('showLoadingOverlayForApiGets');
...
var LoadingOverlayHandler = function (_PureComponent) {
  ...
  _createClass(LoadingOverlayHandler, [{
    ...
    value: function render() {
      ...
      var innerClassName = (0, _classnames3.default)('pace-activity', _defineProperty({}, (0, _testClass2.default)('is-any-api-call-loading'), this.props.isAnyApiCallLoading));
