...
var SingleSignOnHandlerImpl = function (_Component) {
  _inherits(SingleSignOnHandlerImpl, _Component);
...
SingleSignOnHandlerImpl.propTypes = {
  ...
  fetchPrivilegesIfNeeded: _react2.default.PropTypes.func.isRequired
};
