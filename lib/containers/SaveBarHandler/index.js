...
try {
  IS_ACTIVE = !!_Config2.default.get('showSavingBarForApiPostsPuts');
} catch (e) {
  IS_ACTIVE = false;
}
...
var SaveBarHandler = function (_Component) {
  _inherits(SaveBarHandler, _Component);
  ...
  _createClass(SaveBarHandler, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: _style2.default.SaveBarHandler },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              this._getButtonsToDisplay().map(function (buttonDescriptor, buttonLabel) {
...
SaveBarHandler.propTypes = {
  isAnyApiCallSaving: _react2.default.PropTypes.bool.isRequired,
  params: _react2.default.PropTypes.shape({
    mode: _react2.default.PropTypes.string
  }).isRequired,
  routes: _react2.default.PropTypes.array.isRequired,
  pushRoute: _react2.default.PropTypes.func.isRequired,
