...
var requireComponent = function requireComponent(Config) {
  return require('inject-loader?components/ErrorPage&domain/Config!./')({
...
describe('<ErrorPageHandler />', function () {
  describe('component', function () {
    ...
    it('calls clean() for all the failed API calls received', function () {
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(ErrorPageHandler, props));
      var afterButtonClicked = wrapper.find(ErrorPage).prop('afterButtonClicked');
      afterButtonClicked();
